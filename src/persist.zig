...
const VmJson = struct {
    ...
    vnc_port: u16 = vm.VNC_PORT_MIN,
    spice_port: u16 = vm.SPICE_PORT_MIN,
...
fn fromVmJson(j: *const VmJson) vm.VmConfig {
    ...
    cfg.nics[1].mode = vm.NetworkMode.fromStrOr(j.nic2_mode, .none);
    cfg.setNic2Mac(j.nic2_mac);
    cfg.nics[2].mode = vm.NetworkMode.fromStrOr(j.nic3_mode, .none);
    cfg.setNic3Mac(j.nic3_mac);
    cfg.nics[3].mode = vm.NetworkMode.fromStrOr(j.nic4_mode, .none);
    cfg.setNicMacAny(3, j.nic4_mac);
    cfg.nics[4].mode = vm.NetworkMode.fromStrOr(j.nic5_mode, .none);
    cfg.setNicMacAny(4, j.nic5_mac);
    cfg.nics[5].mode = vm.NetworkMode.fromStrOr(j.nic6_mode, .none);
    cfg.setNicMacAny(5, j.nic6_mac);
    cfg.nics[6].mode = vm.NetworkMode.fromStrOr(j.nic7_mode, .none);
    cfg.setNicMacAny(6, j.nic7_mac);
    cfg.nics[7].mode = vm.NetworkMode.fromStrOr(j.nic8_mode, .none);
